...
| 12 | [نطاق الـ MVP](docs/12-mvp-scope.md) | تقسيم صريح للمراحل (Phase 1/2/3) لمنع التضخّم (Over-Engineering) |
| — | [حدود الوحدات](docs/module-boundaries.md) | ما تملكه كل وحدة وواجهتها وأحداثها وتبعياتها |
| — | [سجلات قرارات المعمارية (ADR)](docs/adr/README.md) | القرارات المعمارية الجوهرية بصيغة موحّدة (Context/Decision/Consequences) |
