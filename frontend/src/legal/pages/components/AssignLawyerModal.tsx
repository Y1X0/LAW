  ...
  return (
    <Modal title="إسناد محامٍ" onClose={onClose}>
      <div className="space-y-3">
        ...
        <SelectField label="الدور" value={role} onChange={(e) => setRole(e.target.value)} error={formErrors.fieldError('role')}>
        ...
        <div className="flex justify-end gap-2 pt-1">
          ...
          <Button type="button" onClick={() => { formErrors.reset(); assign.mutate() }} disabled={!selected || assign.isPending}>
